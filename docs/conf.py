...
# its styling lives in docs/_static/github-corner.css. Same treatment as the
# wisefood-client docs, so the two sites behave alike.
html_css_files = ["github-corner.css"]

# Source-repository links (adds per-page "view/edit source" links) and a GitHub
# icon in the footer.
html_theme_options = {
    "source_repository": "https://github.com/wisefood/foodscholar-lib/",
    "source_branch": "main",
    "source_directory": "docs/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/wisefood/foodscholar-lib",
            "html": """
